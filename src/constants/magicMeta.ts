...
export const monsterSuffixes = [
  { name: 'Разрушитель', healthMult: 1.5, armorMult: 1.2, regenMult: 1.3 },
  { name: 'Пожиратель', healthMult: 1.4, armorMult: 1.1, regenMult: 1.4 },
  { name: 'Убийца', healthMult: 1.2, armorMult: 1.3, regenMult: 1.2 },
  { name: 'Защитник', healthMult: 1.6, armorMult: 1.8, regenMult: 1.1 },
  { name: 'Страж', healthMult: 1.8, armorMult: 1.6, regenMult: 1.2 },
  { name: 'Хранитель', healthMult: 1.7, armorMult: 1.4, regenMult: 1.3 },
  { name: 'Истребитель', healthMult: 1.3, armorMult: 1.2, regenMult: 1.3 },
  { name: 'Покоритель', healthMult: 1.5, armorMult: 1.3, regenMult: 1.4 },
  { name: 'Владыка', healthMult: 2.0, armorMult: 1.5, regenMult: 1.6 },
  { name: 'Повелитель', healthMult: 2.2, armorMult: 1.6, regenMult: 1.8 },
  { name: 'Мастер', healthMult: 1.8, armorMult: 1.4, regenMult: 1.5 },
  { name: 'Король', healthMult: 2.5, armorMult: 1.8, regenMult: 2.0 },
  { name: 'Император', healthMult: 3.0, armorMult: 2.0, regenMult: 2.5 },
  { name: 'Бог', healthMult: 4.0, armorMult: 2.5, regenMult: 3.0 },
  { name: 'Чемпион', healthMult: 1.6, armorMult: 1.3, regenMult: 1.4 },
  { name: 'Легенда', healthMult: 1.9, armorMult: 1.5, regenMult: 1.7 },
  { name: 'Мифический', healthMult: 2.1, armorMult: 1.7, regenMult: 1.9 },
  { name: 'Эпический', healthMult: 1.7, armorMult: 1.4, regenMult: 1.6 },
  { name: 'Бессмертный', healthMult: 2.8, armorMult: 1.9, regenMult: 2.3 },
  { name: 'Вечный', healthMult: 3.5, armorMult: 2.2, regenMult: 2.8 },
];
