  ...
  actions: {
    ...
    loadGame() {
      ...
      if (typeof encrypted !== 'string') {
        storeGame.version = storeGlobal.app.version;
        return;
      }
      try {
        ...
        if (loaded.version == storeGlobal.app.version) {
          ...
          storeGame.helpers.cpuMultiplier.percent = new Decimal(
            loaded.helpers.cpuMultiplier.percent,
          );
          ...
          storeGame.helpers.ramMultiplier.percent = new Decimal(
            loaded.helpers.ramMultiplier.percent,
          );
